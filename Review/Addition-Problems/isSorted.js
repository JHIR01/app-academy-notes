/**
 * Write a function isSorted(array) that takes in an array 
 * of numbers and returns true if the elements of the array 
 * are in increasing sorted order and returns false if the
