 ...
 * lowercase string and a number. The function should return 
 * a string where every character of the word is shifted 
 * num times in the alphabet.
 ...
 */
function shiftChars(string, shift){
