/**
 * Write a function safeSpeedChange(speeds) that takes in 
 * an array of speed numbers. The function should return true 
 * if consecutive speeds in the array differ by no more 
