/**
 * Write a function stopWatch(totalSeconds) that takes in a number of seconds. 
 * The function should return the time string based on that number of seconds. 
 * The time should be formatted in hours (H), minutes (M), and seconds(S) in 
 * the form HH:MM:SS.
